 ...
 */
public class SetInputButton extends JButton implements ActionListener {
	/**
     ...
     */
	public SetInputButton(PlayerGraphic targetObject)
	{
		super("Set input");
	...
	/**
     * Kezdeményezi a játékoson keresztül a pumpa bemenetének beállítását,
